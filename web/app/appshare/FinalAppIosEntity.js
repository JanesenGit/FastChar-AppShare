/**
 * FinalAppIosEntity实体类【苹果版本管理】
 */
function FinalAppIosEntity() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (val) {
                        return "&nbsp;<a href='appshare/version?ios=true&pkg=" + val + "' target='_blank'>点击查看</a>&nbsp;";
                    }
                },
                {
                    text: "plist文件",
                ...
                },
                {
                    ...
                    renderer: function (val,m, record) {
                        ...
                        let functionStr = "new FinalAppIosHistoryEntity().showWinList(null,'下载记录', {'t.versionId':" + versionId + "})";
                ...
                },
                {
                    ...
                    renderer: function (val) {
                        ...
                        return "ios" + val + "或更高版本";
                    },
                    field: "textfield"
                },
                {
                    text: "设备列表",
                    dataIndex: "appDevices",
                    align: "center",
                    width: 220,
                    field: "contentfield",
                    renderer: renders.normal()
    ...
    this.showDetails = function (obj, where) {
        ...
        dataStore.load(function (records, operation, success) {
            ...
            showDetailsWindow(obj, "苹果版本详情", me, record);
        });
    };
}